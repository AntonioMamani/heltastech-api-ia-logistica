...
export const CATALOGO_ENTIDADES: Record<string, EntidadConfig> = {
  ...
  mantenimiento: new EntidadConfig('mantenimiento', 'id_mantenimiento', true, ['taller', 'vehiculo'], ['costo_total'], 'estado_ot', ['PENDIENTE', 'EN_PROCESO', 'CERRADA', 'CANCELADA'], 'fecha_inicio_mantenimiento', ['id_vehiculo'], ['mantenimientos', 'mantenimiento de vehiculos', 'ordenes de trabajo']),
